  ...
  require"nest".applyKeymaps{
    { buffer = true, {
      ...
      {"w", {
        ...
        {"l", function() print(vim.inspect(vim.lsp.buf.list_workspace_folders())) end},
...
local servers = { "jsonls", "html", "texlab", "pylsp" }
...
cmp.setup {
  ...
  formatting = {
    format = require("lspkind").cmp_format { with_text = true, max_width = 70 },
  },
}
