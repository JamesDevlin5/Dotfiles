...
let g:startify_bookmarks = [ '~', '~/Documents', '~/Downloads', '~/workspace' ]

" Use relative paths if the file is in/below the current working directory
